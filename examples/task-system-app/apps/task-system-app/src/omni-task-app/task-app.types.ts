...
registerEnumType(JoinTypes, { name: 'JoinTypes' });
...
@ObjectType('TaskExternalRefType')
export class TaskExternalRefType {
  @Field(() => UUIDScalar)
  guid!: string;
...
export const TaskExternalRefGridType = createGridType(
  'TaskExternalRefTypeCrudGenGqlType',
  TaskExternalRefType,
);
...
export class TaskExternalRefCondition {
  @Field(() => UUIDScalar, { nullable: true })
  guid?: string;
}

@InputType('TaskExternalRefUpdateInput')
export class TaskExternalRefUpdateInput {
  @Field({ nullable: true })
  internalType?: string;
  @Field(() => UUIDScalar, { nullable: true })
  internalId?: string;
