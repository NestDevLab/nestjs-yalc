...
export class TaskSystemGraphqlResolver {
  ...
  @Mutation(() => TaskExternalRefType, {
    name: 'TaskSystem_createTaskExternalRef',
  })
  async createTaskExternalRef(
    @Args('input') input: TaskExternalRefCreateInput,
  ) {
    return this.externalRefService.create(input);
  }
  ...
  @Mutation(() => TaskExternalRefType, {
    name: 'TaskSystem_updateTaskExternalRef',
  })
  async updateTaskExternalRef(
  ...
  @Mutation(() => Boolean, { name: 'TaskSystem_deleteTaskExternalRef' })
  ...
  @Query(() => TaskExternalRefType, { name: 'TaskSystem_getTaskExternalRef' })
  async getTaskExternalRef(@Args('ID') id: string) {
    return this.externalRefService.getById(id);
  }
  ...
  async getTaskItemGrid(
    ...
    if (
      ...
      !Object.values(JoinTypes).includes(join.project.joinType)
    ) {
  ...
  @Query(() => TaskExternalRefGridType, {
    name: 'TaskSystem_getTaskExternalRefGrid',
  })
  async getTaskExternalRefGrid(
    @Args('startRow', { nullable: true }) startRow?: number,
    @Args('endRow', { nullable: true }) endRow?: number,
  ) {
    return this.externalRefService.list({ startRow, endRow });
  }
